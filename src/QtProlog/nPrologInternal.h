#ifndef NPROLOGINTERNAL_HPP
#define NPROLOGINTERNAL_HPP
...
extern string itoa(int x, int b=10);
...
public:
  ...
  bool operator != (const Functor& f) const { return handle != f.handle; }
  bool NotEqual    (const Functor& f) const { return handle != f.handle; }
...
class PrologException : public PlError
{
  public:
    virtual Term   as_term() const = 0;
    virtual string message() const = 0;
...
class SafePrologException : public PrologException
{
protected:
  string external;
public:
